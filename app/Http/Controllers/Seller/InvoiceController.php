...
class InvoiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $invoices = Invoice::where('seller_id', auth()->user()->id)->orderBy('id', 'desc');
        ...
        return view('seller.invoices.invoices', compact('invoices', 'buyers', 'sellers'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('seller.invoices.view-invoice', compact('invoice'));
    }
    ...
    public function downloadInvoice($id)
    {
        ...
        $pdf = PDF::loadView('seller.invoices.invoice_template', compact('invoice'));
