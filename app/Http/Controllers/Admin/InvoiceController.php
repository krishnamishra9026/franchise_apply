...
class InvoiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.invoices.invoices', compact('invoices', 'buyers', 'sellers'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.invoices.view-invoice', compact('invoice'));
    }
    ...
    public function downloadInvoice($id)
    {
        ...
        $pdf = PDF::loadView('admin.invoices.invoice_template', compact('invoice'));
