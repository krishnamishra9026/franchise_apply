                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" data-toggle="select2" required name="manufacturer">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" data-toggle="select2" required name="model">
                                        <option value="">Please Select</option>
                                        @foreach($models as $model)
                                        <option @if($model->id == request()->get('model')) selected @endif value="{{ $model->id }}">{{ $model->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" data-toggle="select2" required name="range"> 
                                        <option value="">Please Select</option>
                                        @foreach($ranges as $range)
                                        <option @if($range->id == request()->get('range')) selected @endif value="{{ $range->id }}">{{ $range->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" data-toggle="select2" required name="variant">
                                        <option value="">Please Select</option>
                                        @foreach($variants as $variant)
                                        <option @if($variant->id == request()->get('variant')) selected @endif value="{{ $variant->id }}">{{ $variant->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
