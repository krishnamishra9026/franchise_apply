                ...
                <div class="table-responsive">
                    <table class="table-panel table table-bordered table-striped table-centered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center"><a href="{{ route('seller.invoices.show', $invoice->id) }}">#{{ $invoice->id }}</a></td>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-primary btn-sm" href="{{ route('seller.invoices.show', $invoice->id) }}"><i class="dripicons-preview"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            @else
