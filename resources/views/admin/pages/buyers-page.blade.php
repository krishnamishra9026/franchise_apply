            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.page.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="section_2" cols="30" rows="5" class="form-control summernote" placeholder="Content">{{ (isset($page))?old('section_2',$page->section_2):old('section_2') }}</textarea>
                    </div>
