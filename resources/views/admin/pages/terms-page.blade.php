            ...
            <div class="card-body">
                 <form method="POST" action="{{ route('admin.page.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="section_1" cols="30" rows="5" class="form-control summernote" placeholder="Terms and Conditions">{{ (isset($page))?old('section_1',$page->section_1):old('section_1') }}</textarea>
                    </div>
