        ...
        <div class="col-sm-4 hidden-xs" style="padding:0">
            <div style="background:#000;min-height: 100vh">
                ...
                <div class="text-center ctr">
                    <a href="{{route('buyer.register')}}" class="btn btn-danger btn-lg" style="box-shadow: none;font-family:Outfit">Create a buyer account</a>
                </div>
            </div>
        </div>
        <div class="col-sm-8" style="padding:0">
            ...
            <div class="content-right">
                ...
                <div class="bothUser text-center" style="margin: 30px 0">
                    <a href="javascript:void(0)" class="btn btn-danger">I am a buyer</a>
                    <a href="{{ route('seller.login')}}" class="btn btn-outline ms-2">I am a seller</a>
                </div>
                ...
                <form method="POST" action="{{ route('buyer.login') }}">
                    ...
                    <div class="mb-3">
                            ...
                            <a href="{{ route('buyer.password.request') }}" class="text-muted float-end"><small>Forgot
                    ...
                    <div class="d-grid mb-0 text-center">
                        <button class="btn btn-danger btn-userlogin" type="submit">Log In</button>
                    </div>
                    <div class="mb-3">
                        <p class="dont-account">Don't have a buyer account? <a href="{{ route('buyer.register') }}">Create Now</a></p>
                    </div>
                </form>
            </div>
        </div>
