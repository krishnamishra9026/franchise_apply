        ...
        <p class="go-home greg"><a href="/">< Back to home</a></p>
            <div class="content-right">
                ...
                <div class="bothUser text-center" style="margin: 30px 0">
                    <a href="javascript:void(0)" class="btn btn-danger" style="box-shadow: none">I am a buyer</a>
                    <a href="{{ route('seller.register') }}" class="btn btn-outline ms-2" style="box-shadow: none">I am a seller</a>
                </div>
                ...
                <form method="POST" action="{{ route('buyer.register') }}">
                    ...
                    <div class="mb-3">
                        <p class="dont-account">Already have an account? <a href="{{ route('buyer.login') }}">Sign In</a></p>
                    </div>
                </form>
            </div>
        </div>
        <div class="col-sm-5 hidden-xs" style="padding:0">
            <div style="background:#000;min-height: 100vh">
                ...
                <div class="text-center ctr">
                    <a href="{{route('buyer.login')}}" class="btn btn-danger btn-lg" style="box-shadow: none">Sign In</a>
                </div>
            </div>
        </div>
    </div>
