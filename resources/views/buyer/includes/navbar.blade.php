            ...
            <ul class="list-unstyled topbar-menu float-end mb-0">
                ...
                <li class="dropdown notification-list">
                    <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                        ...
                        <span>
                            <span class="account-user-name">{{ Auth::guard('buyer')->user()->firstname }} {{ Auth::guard('buyer')->user()->lastname }}</span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                        ...
                        <!-- item-->
                        <a href="{{ route('buyer.my-account.edit', Auth::guard('buyer')->id()) }}" class="dropdown-item notify-item">
                    ...
                    onclick="event.preventDefault(); document.getElementById('logout-form').submit();"  class="dropdown-item notify-item">
                        ...
                        <form id="logout-form"
                            action="{{ 'App\Models\Buyer' == Auth::getProvider()->getModel() ? route('buyer.logout') : route('buyer.logout') }}"
