    ...
    <div class="card mt-3">
        <div class="card-body">
            ...
            <div class="d-print-none mt-4">
                <div class="text-end">
                    <a href="{{ route('buyer.invoices.download', $invoice->id) }}" class="btn btn-sm btn-secondary"><i class="mdi mdi-printer"></i>
                        Print</a>
                    <a href="{{ route('buyer.invoices.index') }}" class="btn btn-sm btn-dark"><i class="mdi mdi-chevron-double-left me-1"></i>
                        Back</a>
                </div>
            </div>
        </div>
